        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-2xl w-full">
                <div className="flex flex-col items-center mb-6">
                    ...
                    {isNew && (
                        <div className="bg-green-100 text-green-800 font-bold text-sm px-4 py-2 rounded-full shadow-sm">
                            🎉 New Product!
                        </div>
                    )}
                </div>
                ...
                <div className="flex justify-center mt-4">
                    <button
                        ...
                        className="mt-4 px-4 py-2 bg-blue-500 text-white rounded shadow hover:bg-blue-700 transition-all"
                    >
                        Back
                    </button>
                </div>
